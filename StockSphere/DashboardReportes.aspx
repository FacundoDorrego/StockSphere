...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container my-4">
        ...
        <asp:GridView ID="dgvVentas" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover table-bordered" Visible="false">
            <Columns>
                <asp:BoundField DataField="VentasID" HeaderText="Venta N°:" HeaderStyle-CssClass="text-center" />
                <asp:BoundField DataField="FechaVenta" HeaderText="Fecha de venta:" HeaderStyle-CssClass="text-center" />
                <asp:BoundField DataField="Usuario.UsuarioID" HeaderText="Usuario ID:" HeaderStyle-CssClass="text-center" />
                <asp:BoundField DataField="Usuario.NombreUsuario" HeaderText="Nombre del usuario:" HeaderStyle-CssClass="text-center" />
                <asp:BoundField DataField="ProductoID" HeaderText="Producto:" HeaderStyle-CssClass="text-center" />
                <asp:BoundField DataField="Producto.Nombre" HeaderText="Nombre del producto:" HeaderStyle-CssClass="text-center" />
                <asp:BoundField DataField="Producto.Precio" HeaderText="Precio c/u:" HeaderStyle-CssClass="text-center" />
                <asp:BoundField DataField="Categoria.Nombre" HeaderText="Categoría:" HeaderStyle-CssClass="text-center" />
                <asp:BoundField DataField="Cantidad" HeaderText="Cantidad vendida:" HeaderStyle-CssClass="text-center" />
                <asp:BoundField DataField="Monto" HeaderText="Monto Total:" HeaderStyle-CssClass="text-center" />
            </Columns>
    ...
    <div class="container my-4">
        ...
        <canvas id="chartVentas" style="width: 100%; max-width: 600px; margin: auto;"></canvas>
    </div>
